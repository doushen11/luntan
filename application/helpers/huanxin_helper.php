<?php 
   ...
   class Huanxin{
      ...
      public function __construct($options = null)
      {
         if($options == null){
            $options = array(
               'client_id' => 'YXA6XL7JQC_bEeeTVFcvzfh56Q',
               'client_secret' => 'YXA6LXIZsgzmcgLwW22-r23lovBgdzc',
               'org_name' => '1105170503178537',
               'app_name' => 'thisisatestapp',
            );
         }
      ...
      */
       ...
       * 禁言个人
       */
      function gagGroupMember($group_id,$username){
       ...
       * 对个人解除禁言
       */
      function ugagGroupMember($group_id,$username){
