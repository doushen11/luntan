...
<div id="middle">
    ...
    <div class="right"  id="mainFrame">
        ...
        <form id="form2" name="form2" action="<?php echo base_url().'index.php/admin/admin/admin/role_update/' . $role_permissions["id"];?>" onSubmit="return adds();">
           <table class="table table-bordered">
             <tr>
                 <td width="10%" height="50" align="right" bgcolor="#f1f1f1">角色名称：</td>
                 <td height="50"><div style="width:20%;float:left;padding-left:1%;"><input type="text" name="controller_name" id="controller_name" class="span1-11" value="<?php echo $role_permissions["name"];?>" /></div></td>
             </tr>
             <tr>
               ...
               <div class="recson">
                    ...
                    <ul>
                        ...
                        ?>
                        <li>
                            <span><input type="checkbox" class="sx_<?php echo $a;?>" id="sx_<?php echo $a;?>" name="levels" value="<?php echo $arr3[0];?>" <?php if(substr_count($role_permissions["controller_funcs"],"{".$arr3[0]."}")>0){echo "checked";}?> /></span> <?php echo $arr3[1];?>
                        </li>
                        <?php
                            }
                        ?>
         ...
         <table  class="margin-bottom-20 table  no-border" >
            <tr>
                <td class="text-center"><input type="submit" value=" 修 改 " class="btn btn-info " style="width:80px;" /></td>
            </tr>
         </table>
     </form>
            </div>
